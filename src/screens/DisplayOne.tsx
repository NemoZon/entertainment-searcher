...
type RootStackParamList = {
    ...
    DisplayTwo: undefined; // Remplace par la prochaine page
};

type DisplayOneProps = NativeStackScreenProps<RootStackParamList, 'DisplayOne'>;

const interests = ['Concerts', 'Théâtre', 'Sports', 'Ateliers', 'Dance'];

const DisplayOne = ({ navigation }: DisplayOneProps) => {
